<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Bookgascylinder.aspx.cs" Inherits="Default2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <hr />
    <br />
   <h3><b>BOOK YOUR GAS CYLINDER&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </b>
       <asp:Button ID="Button2" runat="server" CssClass="btn btn-primary" PostBackUrl="~/Gasregistration.aspx" Text="Consumer Registration" />
    </h3>
    <hr />
    <div class="cdf-23">
        ...
        <table class="auto-style1">
            ...
            <tr>
                <td class="auto-style3">Name<span class="auto-style6">* </span><span class="auto-style15">:</span></td>
            ...
            <tr>
                <td class="auto-style16">Refill or User ID<span class="auto-style6">*</span> :</td>
